						...
						<Card className="bg-surface/50 border border-border h-full">
							<CardBody className="p-8">
								<div className="flex items-center gap-4 mb-6">
									...
									<div>
										<Chip color="primary" variant="flat" size="sm" className="mb-1">
											State Law
										</Chip>
								...
								<p className="text-foreground-secondary mb-4">
									California's AB 645 authorizes automated speed enforcement pilot programs
									in select cities. Traffic Owl's Falcon system is designed to meet all
									requirements of this groundbreaking legislation.
								</p>
								<ul className="space-y-2">
									{["Automated speed enforcement", "Evidence-grade documentation", "Privacy protections built-in"].map((item) => (
						...
						<Card className="bg-surface/50 border border-border h-full">
							<CardBody className="p-8">
								<div className="flex items-center gap-4 mb-6">
									...
									<div>
										<Chip color="secondary" variant="flat" size="sm" className="mb-1">
											Safety Initiative
										</Chip>
										<h3 className="text-xl font-semibold text-foreground">
											Vision Zero Aligned
								...
								<p className="text-foreground-secondary mb-4">
									Vision Zero is California's commitment to eliminating traffic fatalities
									and serious injuries. Traffic Owl directly supports these objectives
									through comprehensive enforcement.
								</p>
								<ul className="space-y-2">
									{["Reduce serious crashes", "Protect vulnerable road users", "Data-driven enforcement"].map((item) => (
										<li key={item} className="flex items-center gap-2 text-sm text-foreground-secondary">
