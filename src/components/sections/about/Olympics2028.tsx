...
import { ShieldIcon, SpeedIcon, UsersIcon } from "@/components/icons";
...
const OLYMPICS_BENEFITS = [
  {
    ...
    description:
      "Olympic-scale traffic demands infrastructure that can handle unprecedented volume without compromising safety.",
    icon: UsersIcon,
  },
  {
    title: "Global Scrutiny",
    description:
      "The world will be watching. Modern enforcement technology projects a positive international image.",
    icon: ShieldIcon,
  },
  {
    title: "Predictable Flow",
    description:
      "Real-time traffic analytics ensure smooth operations near venues and key corridors.",
    icon: SpeedIcon,
  },
];
          ...
          <Card className="bg-gradient-to-br from-primary/5 to-secondary/5 border border-primary/20">
            <CardBody className="p-8 text-center">
              <p className="text-lg text-foreground-secondary max-w-3xl mx-auto">
                Falcon + Owl Grid ensure safer intersections, predictable
                traffic flow, and a positive international image for Los Angeles
                and surrounding cities hosting Olympic events and visitors.
              </p>
            </CardBody>
          </Card>
        </FadeIn>
