...
import { ServerIcon, DatabaseIcon, ShieldIcon, ChipIcon } from "@/components/icons";

const PLATFORM_FEATURES = [
	{
		title: "Central Monitoring System",
		description: "Comprehensive dashboard for managing all enforcement units, viewing real-time status, and analyzing violation data.",
		icon: ServerIcon,
	},
	{
		title: "Analytics & Reporting",
		description: "Advanced analytics with customizable reports, traffic flow statistics, and violation trend analysis.",
		icon: DatabaseIcon,
	},
	{
		title: "Data Security",
		description: "End-to-end encryption, secure data transmission, and compliance with privacy regulations including CCPA.",
		icon: ShieldIcon,
	},
	{
		title: "Linux-Based OS",
		description: "Stable, secure operating system resistant to viruses and hacker attacks, with no licensing fees.",
		icon: ChipIcon,
	},
];
						...
						{PLATFORM_FEATURES.map((feature) => {
							...
							return (
								<StaggerItem key={feature.title}>
									<Card
										className="bg-surface/30 border border-border hover:border-primary/30 transition-colors"
									>
