...
import { ShieldIcon, CheckCircleIcon, ArrowRightIcon } from "@/components/icons";

const COMPLIANCE_ITEMS = [
	{
		title: "California AB 645",
		description: "Fully compliant with California's automated speed enforcement pilot program requirements.",
	},
	{
		title: "CCPA Compliance",
		description: "Data handling practices meet California Consumer Privacy Act standards for citizen data protection.",
	},
	{
		title: "Evidence Standards",
		description: "All captured evidence meets legal standards for traffic violation prosecution.",
	},
	{
		title: "Data Retention",
		description: "Configurable data retention policies to meet local regulatory requirements.",
	},
	{
		title: "Audit Logging",
		description: "Complete audit trails for all system access and data modifications.",
	},
	{
						...
						<CardBody className="p-8">
							...
							<div className="text-center">
								<p className="text-foreground-secondary mb-4">
									Have questions about compliance? Our team can provide detailed documentation.
								</p>
								<Button
									as={Link}
									href="/contact"
