...
import { ChipIcon, TargetIcon, CameraIcon, BoltIcon } from "@/components/icons";

const AI_FEATURES = [
	{
		title: "Neural Network Architecture",
		description: "Custom-designed deep learning models trained on millions of traffic scenarios for accurate violation detection.",
		icon: ChipIcon,
		stats: [
	...
	},
	{
		...
		description: "Advanced OCR with 95%+ accuracy even in challenging conditions like rain, fog, or low light.",
		icon: TargetIcon,
		stats: [
	...
	},
	{
		...
		description: "Proprietary algorithms enhance low-light imagery, producing evidence-quality captures 24/7.",
		icon: CameraIcon,
		stats: [
	...
	},
	{
		...
		description: "On-device tensor processing eliminates latency and enables instant violation detection.",
		icon: BoltIcon,
		stats: [
					...
					{AI_FEATURES.map((feature) => {
						...
						return (
							<StaggerItem key={feature.title}>
								<Card
									className="bg-surface/30 border border-border hover:border-primary/30 transition-colors h-full"
								>
