...
import { ArrowRightIcon, MapPinIcon, TargetIcon, ShieldIcon, ClockIcon } from "@/components/icons";
							...
							<div className="grid md:grid-cols-2">
								...
								<div className="p-8 md:p-10">
									...
									<p className="text-foreground-secondary mb-6 leading-relaxed">
										Traffic Owl is partnering with the City of Glendale to prepare
										for the 2028 Olympics. Our comprehensive traffic enforcement
										system will help ensure safe roads for residents and visitors
								...
								<div className="relative bg-surface p-8 flex items-center justify-center min-h-[300px] overflow-hidden">
									...
									<div className="absolute inset-0 flex items-center justify-center">
										...
										<div className="absolute w-64 h-64 rounded-full border border-secondary/10 animate-pulse" style={{ animationDelay: "0.5s" }} />
										<div className="absolute w-80 h-80 rounded-full border border-primary/5 animate-pulse" style={{ animationDelay: "1s" }} />
									</div>
									...
									<div className="absolute bottom-1/4 right-1/3 w-2 h-2 bg-secondary/30 rounded-full animate-float" style={{ animationDelay: "0.5s" }} />
