...
const HIGHLIGHT_FEATURES = [
  {
    ...
    description:
      "Neural networks trained to detect multiple violation types with 95%+ accuracy.",
    icon: "ai" as const,
  },
  {
    title: "Solar Powered",
    description:
      "15W consumption allows deployment anywhere without grid connection.",
    icon: "sun" as const,
  },
  {
    title: "Instant Processing",
    description:
      "On-device edge computing for real-time violation detection and evidence capture.",
    icon: "bolt" as const,
  },
  {
    title: "24/7 Operation",
    description:
      "High-clarity night vision ensures round-the-clock enforcement capability.",
    icon: "clock" as const,
  },
];
