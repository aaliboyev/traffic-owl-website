...
const PREVIEW_SOLUTIONS = [
  {
    ...
    description:
      "Automated speed monitoring invisible to radar detectors with high accuracy license plate recognition.",
  ...
  },
  {
    ...
    description:
      "24/7 intersection monitoring to prevent dangerous violations and reduce accidents.",
  ...
  },
  {
    ...
    description:
      "Crosswalk protection ensuring drivers yield to pedestrians for safer streets.",
