...
const VIDEO_URL =
  "https://frrygwgnwimju6id.public.blob.vercel-storage.com/traffic_owl_compressed.mp4";
          ...
          <div>
            ...
            <FadeIn delay={0.2}>
              <p className="text-lg text-foreground-secondary mb-8">
                Falcon is a multi-violation automated enforcement unit designed
                for 24/7 unattended operation. Featuring industry-first dual
                verification—radar and video frame-by-frame analysis—it delivers
                superior accuracy and evidentiary robustness. Available in
                stationary, mobile, and portable configurations.
              </p>
            </FadeIn>
