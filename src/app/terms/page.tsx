...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Service for Traffic Owl and the Falcon traffic enforcement system.",
};
              ...
              <div className="space-y-8 text-foreground-secondary">
                <div>
                  ...
                  <p className="leading-relaxed">
                    By accessing or using the Traffic Owl website and services,
                ...
                <div>
                  ...
                  <p className="leading-relaxed">
                    Traffic Owl provides AI-powered traffic enforcement systems,
                    including the Falcon violation detection system, to
                    municipal clients. Our website provides information about
                    our products and services and allows visitors to request
                    demonstrations and contact our team.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>
                      Collect or harvest any information from our website
                      without permission
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p className="leading-relaxed">
                    ...
                    logos, images, and software, is the property of Traffic Owl
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-foreground mb-4">
                    5. Municipal Client Services
                  </h2>
                  <p className="leading-relaxed">
                    Traffic enforcement services provided to municipal clients
                    are governed by separate service agreements. These Terms of
                    Service apply to website visitors and do not supersede any
                    agreements between Traffic Owl and its municipal clients.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="leading-relaxed">
                    ...
                    warrant that the website will be uninterrupted, error-free,
                ...
                <div>
                  ...
                  <p className="leading-relaxed">
                    To the fullest extent permitted by law, Traffic Owl shall
                ...
                <div>
                  ...
                  <p className="leading-relaxed">
                    You agree to indemnify and hold harmless Traffic Owl, its
                ...
                <div>
                  ...
                  <p className="leading-relaxed">
                    ...
                    resolved in the courts located in Los Angeles County,
                    California.
                  </p>
                </div>
